...
from sentence_transformers.STS.InputExampleSTS import InputExampleSTS


class SentencesDatasetSTS(Dataset):
    """
    ...
    """
    def __init__(self, examples: List[InputExampleSTS], model: SentenceTransformer, show_progress_bar: bool = None):
        """
    ...
    def convert_input_examples(self, examples: List[InputExampleSTS], model: SentenceTransformer):
        """
